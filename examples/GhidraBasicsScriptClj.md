---
title: Ghidra Basics in Clojure
keywords: clojure, ghidra, basics
last_updated: July 3, 2021
layout: default
summary: Basic Ghidra scripting using Clojure.
---

# Ghidra Basics in Clojure
The following script demonstrates how to accomplish some simple tasks in Ghidra
using the Clojure capability provided by Ruby Dragon. Note the use of the
automatic global variables to get state information, and the use of standard
Clojure idioms.
